//! Ã¨Â§ÂÃ¥ÂÂ bot Ã¨Â¾ÂÃ¥ÂÂºÃ§Â»ÂÃ¦Â­Â¤Ã©ÂÂ¨Ã¦ÂÂ§Ã¯Â¼ÂÃ¦Â»Â¤Ã¦ÂÂÃ¦ÂÂ¬Ã¥Â´ÂÃ¤Â¹Â±Ã¨ÂµÂ°Ã£ÂÂÃ§Â©ÂºÃ§Â ÂÃ£ÂÂÃ§Â©ÂºÃ¦ÂÂ¡Ã§Â­ÂÃ¦ÂÂ Ã¦ÂÂÃ¥ÂÂ¨Ã¤Â½ÂÃ£ÂÂ
...
/// Ã©ÂÂ¨Ã¦ÂÂ§Ã¤Â¸ÂÃ¤Â¸ÂÃ¦ÂÂÃ¯Â¼ÂÃ§ÂÂ± sim Ã¦Â¯Â tick Ã¦ÂÂÃ©ÂÂ Ã¯Â¼ÂÃ£ÂÂ
...
pub struct MovementGateCtx {
    ...
    /// sim Ã¥ÂÂ¤Ã¥Â®ÂÃ¥ÂÂÃ¦ÂÂ¹Ã¨Â¾Â¹Ã§Â¼ÂÃ¥ÂÂ¯Ã¨ÂÂ½Ã¤Â¸ÂÃ¯Â¼ÂÃ¤Â¸ÂÃ¦ÂÂ¹Ã¦ÂÂÃ¦ÂÂ´Ã¤Â½ÂÃ¥Â¹Â³Ã¥ÂÂ°Ã¯Â¼ÂÃ£ÂÂ
    pub physics_drop_right: Option<bool>,
    pub physics_drop_left: Option<bool>,
    pub sim_mob_in_melee: bool,
    /// 玩家在怪背后时允许平地跳跃绕前（不依赖 YOLO 敌槽）。
...
/// Ã¦ÂÂÃ¦ÂÂÃ¦ÂÂÃ¨Â¿ÂÃ¨Â§ÂÃ¦ÂµÂÃ¯Â¼ÂÃ¥Â¯Â¹ bot Ã¦ÂÂÃ¥ÂÂ¾Ã¥ÂÂÃ¥Â®ÂÃ¥ÂÂ¨Ã¨Â¿ÂÃ¦Â»Â¤Ã£ÂÂ
#[derive(Debug, Clone)]
...
impl MovementGate {
    ...
    pub fn filter_input(&self, input: &InputFrame, ctx: MovementGateCtx) -> InputFrame {
        ...
        // Ã¦ÂÂ¬Ã¥Â´ÂÃ¨Â·Â³Ã©ÂÂÃ¤Â¿ÂÃ§ÂÂÃ¦ÂÂ¹Ã¥ÂÂÃ¦ÂÂÃ¥ÂÂ¾Ã¯Â¼ÂÃ¨ÂÂ¥Ã¥ÂÂÃ¦Â¸ÂÃ¦ÂÂ left/rightÃ¯Â¼Âcliff_jump Ã¦Â°Â¸Ã¨Â¿ÂÃ¥ÂÂ¤Ã¤Â¸ÂÃ¨Â¿ÂÃ£ÂÂ
        ...
        if out.jump {
            if ctx.climbing {
                ...
                if phys_drop || (cliff_jump && !combat && !ctx.sim_mob_in_melee) {
                    // sim Ã¦ÂÂ¬Ã¥Â´Â/Ã¨ÂÂ½Ã§ÂÂ¹Ã¨Â·Â³Ã¯Â¼ÂÃ©ÂÂÃ¦ÂÂÃ¦ÂÂÃ¦ÂÂ¶Ã¥ÂÂÃ¨Â®Â¸Ã¨Â¶ÂÃ§Â¼ÂÃ¦ÂÂ¢Ã¥ÂÂº
                } else if combat {
                    out.jump = false;
        ...
        // Ã¨Â·Â³Ã¨Â¢Â«Ã¦Â»Â¤Ã¦ÂÂÃ¥ÂÂÃ¯Â¼ÂÃ¤Â¸ÂÃ¤Â¸ÂºÃ¦ÂÂ¬Ã¥Â´ÂÃ¤Â¿ÂÃ§ÂÂÃ§ÂÂÃ¦ÂÂ¹Ã¥ÂÂÃ©ÂÂ®Ã¤Â¸ÂÃ¥ÂºÂÃ§Â»Â§Ã§Â»Â­Ã¨ÂµÂ°Ã¨Â¿ÂÃ¨ÂÂÃ§Â©ÂºÃ£ÂÂ
        ...
        if out.attack {
            // bot_play ä»¥ sim æ¥ç æ¡ä¸ºåï¼YOLO è´´èº«å¸¸æ¼æ£ï¼ä¸è½åè¦æ± obs ä¹å¨èå´åã
